	...
	<div class="page-group">
		<div class="page">
			<header class="bar bar-nav">
				<a class="button button-link button-nav pull-left" href="javascript:void(0)" data-transition='slide-out' onclick="back()"> 
			...
			<nav class="bar bar-tab">
				<a class="tab-item" href="javascript:void(0)" onclick="back()">
